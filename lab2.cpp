...
int main() {
    ...
    cout<<"\nThe words starts with letters 'ha':"<<endl;
    for (int i = 0; i < 1000; i++) {
        firstCharacter=words[i][0];
        secondCharacter=words[i][1];

        if (firstCharacter=="h" && secondCharacter=="a")
            cout<<words[i]<<endl;
    }
    ...
    int starCounter=1,limit=number;
    ...
    for (int i = 1; i <= 2*number ; i++) {
        ...
        cout<<"You should have entered between 3 and 9";
